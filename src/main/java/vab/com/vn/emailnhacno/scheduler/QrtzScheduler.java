//package vab.com.vn.hrautomail.scheduler;
//
...
//import vab.com.vn.hrautomail.config.AutoWiringSpringBeanJobFactory;
//
//@Configuration
...
//
//        return newJob().ofType(JobExecute.class).storeDurably().withIdentity(JobKey.jobKey("Qrtz_Job_Detail")).withDescription("Invoke Sample Job service...").build();
//    }
//
//    @Bean
